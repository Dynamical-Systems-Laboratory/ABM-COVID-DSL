...
int main(int argc, char* argv[])
{
	...
	int inf0 = 22;
	int n_vac = 0;
   	// Vaccination properties - random vaccination
	if (argc != 2){
		std::cerr << 
				"Number of agents to vaccinate missing. Run as ./cmdl n_vaccinated" 
				<< std::endl;
		exit(1);	
	}
	n_vac = std::stoi(argv[1]);
	...
	// Vaccination setup
	abm.set_random_vaccination(n_vac);
